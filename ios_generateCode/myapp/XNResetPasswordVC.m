...
#import "XNResetPasswordVC.h"

@interface XNResetPasswordVC()

@end


@implementation XNResetPasswordVC
...
- (XNResetPwdFooterView *)footerView
{
	if(!_footerView) {
		_footerView = createView(XNResetPwdFooterView);
