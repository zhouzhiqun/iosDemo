...
#import "XNModifyPwdVM.h"

@interface XNModifyPwdVC : XNLViewController

@property (nonatomic, strong, readonly) XNModifyPwdVM *viewModel;

- (instancetype)initWithVM:(XNModifyPwdVM *)viewModel;

@property(nonatomic, strong)XNModifyPwdFooterView *footerView;
